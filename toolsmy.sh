...
clear
echo
figlet Mr.Helfynt Tools
echo $pur"______________________"$cy" ___________________________"
echo $i"CWD"$pu"  AUTHOR  :  Mr.Helfynt  "$i"                               CBS"
echo $i"CWD"$pu"  WhatsApp:  0812936xxxxx"$i"                    CBS"
echo $i"CWD"$pu"  GMAIL   :  kegantengan06@gmail.com"$i" CBS"
echo $i"CWD"$pu"  YOUTUBE :  NoNaMe"$i"                 CBS"
echo $pur"______________________"$cy"____________________________"
echo
figlet Menu Tools | lolcat
echo $cy" IS SO HARD MY TOOL:"
echo $b "=========================" | lolcat
echo $b "1.   REPORT FB";
echo $b "=========================" | lolcat
echo $b "2.   BRUTE FORCE";
echo $b "=========================" | lolcat
...
echo $b "=========================" | lolcat
echo $b "13.  ShellPhish";
echo $b "=========================" | lolcat
echo $b "14.  DarkFly (540 Tools)";
echo $b "=========================" | lolcat
echo $b "15.  Tools TUANB4DUT";
echo $b "=========================" | lolcat
echo $b "16.  Tools Mr.Ryuxhan";
echo $b "=========================" | lolcat
echo $b "17.  Bikin Virus";
echo $b "=========================" | lolcat
echo $b "18.  Kumpulan Brute Force Fb";
echo $b "=========================" | lolcat
echo $b "19.  Bikin Script Deface";
echo $b "=========================" | lolcat
echo $b "20.  20 Tools Mantap Jiwa";
echo $b "=========================" | lolcat
echo $b "21.  BomSms";
echo $b "=========================" | lolcat
echo $b "22.  Admin_LoginTermux";
echo $b "=========================" | lolcat
echo $b "23.  Tools B4J1n64n v6";
echo $b "=========================" | lolcat
...
sleep 2
echo $i"Silahkan di pakai dengan bijak, Semoga bermanfaat Buat anda"
sleep 2
echo $pur"Bila Ada Kesalahan Anda Bisa Nanya Melalui Via"
sleep 2
echo $ku"Facebook   :"$i" Ferdi Helfynt"
echo $ku"Instagram  :"$i" pngendifollow_"
echo $ku"WhatsApp   :"$i" 0812936xxxxx"
sleep 2
